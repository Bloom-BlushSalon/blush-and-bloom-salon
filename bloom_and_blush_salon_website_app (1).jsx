      ...
      <section className="relative py-20 px-6 bg-gradient-to-br from-black via-pink-950 to-black text-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-10">
            Select your service and choose your appointment time. Payments are made in person at your appointment. No customer account required.
          </p>

          <div className="bg-white text-black rounded-3xl p-8 shadow-2xl text-left">
            <div className="bg-pink-100 border border-pink-200 rounded-2xl p-4 mb-6 text-sm text-pink-900">
              ✨ Live booking calendar enabled<br />
              ✨ Taken appointments are automatically blocked off<br />
              ✨ Automatic text reminders sent before appointments
            </div>
            ...
            <div className="bg-pink-50 border border-pink-200 rounded-2xl p-4 mt-6 mb-6 text-sm text-gray-700 shadow-sm">
              ✔ Customers can book without creating an account<br />
              ✔ Pay in person at your appointment<br />
              ✔ Text reminders sent to both salon and client
            </div>

            <button className="mt-2 w-full bg-pink-500 hover:bg-pink-600 text-white py-4 rounded-2xl text-lg font-semibold transition-all">
              Reserve Appointment
            </button>
          </div>
        </div>
